.class public final Luniffi/textrcs_libgm/FfiConverterSequenceString;
...
.annotation system Ldalvik/annotation/SourceDebugExtension;
    value = "SMAP\ntextrcs_libgm.kt\nKotlin\n*S Kotlin\n*F\n+ 1 textrcs_libgm.kt\nuniffi/textrcs_libgm/FfiConverterSequenceString\n+ 2 _Collections.kt\nkotlin/collections/CollectionsKt___CollectionsKt\n+ 3 Iterators.kt\nkotlin/collections/CollectionsKt__IteratorsKt\n*L\n1#1,5003:1\n1549#2:5004\n1620#2,3:5005\n32#3,2:5008\n*S KotlinDebug\n*F\n+ 1 textrcs_libgm.kt\nuniffi/textrcs_libgm/FfiConverterSequenceString\n*L\n4749#1:5004\n4749#1:5005,3\n4755#1:5008,2\n*E\n"
.end annotation
...
.annotation runtime Lkotlin/Metadata;
    ...
    d2 = {
        "Luniffi/textrcs_libgm/FfiConverterSequenceString;",
        "Luniffi/textrcs_libgm/FfiConverterRustBuffer;",
        "",
        "",
        "()V",
...
# static fields
.field public static final INSTANCE:Luniffi/textrcs_libgm/FfiConverterSequenceString;
...
.method static constructor <clinit>()V
    ...
    new-instance v0, Luniffi/textrcs_libgm/FfiConverterSequenceString;

    invoke-direct {v0}, Luniffi/textrcs_libgm/FfiConverterSequenceString;-><init>()V

    sput-object v0, Luniffi/textrcs_libgm/FfiConverterSequenceString;->INSTANCE:Luniffi/textrcs_libgm/FfiConverterSequenceString;
...
.method public bridge synthetic allocationSize-I7RO_PI(Ljava/lang/Object;)J
    ...
    invoke-virtual {p0, v0}, Luniffi/textrcs_libgm/FfiConverterSequenceString;->allocationSize-I7RO_PI(Ljava/util/List;)J
...
.method public allocationSize-I7RO_PI(Ljava/util/List;)J
    ...
    .line 4749
    .local v10, "$i$a$-map-FfiConverterSequenceString$allocationSize$sizeForItems$1":I
    sget-object v11, Luniffi/textrcs_libgm/FfiConverterString;->INSTANCE:Luniffi/textrcs_libgm/FfiConverterString;

    invoke-virtual {v11, v9}, Luniffi/textrcs_libgm/FfiConverterString;->allocationSize-I7RO_PI(Ljava/lang/String;)J

    move-result-wide v9

    .end local v9    # "it":Ljava/lang/String;
    .end local v10    # "$i$a$-map-FfiConverterSequenceString$allocationSize$sizeForItems$1":I
...
.method public bridge synthetic lift(Ljava/lang/Object;)Ljava/lang/Object;
    ...
    invoke-virtual {p0, v0}, Luniffi/textrcs_libgm/FfiConverterSequenceString;->lift(Luniffi/textrcs_libgm/RustBuffer$ByValue;)Ljava/util/List;
...
.method public bridge synthetic lift(Luniffi/textrcs_libgm/RustBuffer$ByValue;)Ljava/lang/Object;
    ...
    .line 4739
    invoke-virtual {p0, p1}, Luniffi/textrcs_libgm/FfiConverterSequenceString;->lift(Luniffi/textrcs_libgm/RustBuffer$ByValue;)Ljava/util/List;
...
.method public bridge synthetic liftFromRustBuffer(Luniffi/textrcs_libgm/RustBuffer$ByValue;)Ljava/lang/Object;
    ...
    .line 4739
    invoke-virtual {p0, p1}, Luniffi/textrcs_libgm/FfiConverterSequenceString;->liftFromRustBuffer(Luniffi/textrcs_libgm/RustBuffer$ByValue;)Ljava/util/List;
...
.method public bridge synthetic lower(Ljava/lang/Object;)Ljava/lang/Object;
    ...
    invoke-virtual {p0, v0}, Luniffi/textrcs_libgm/FfiConverterSequenceString;->lower(Ljava/util/List;)Luniffi/textrcs_libgm/RustBuffer$ByValue;
...
.method public bridge synthetic lowerIntoRustBuffer(Ljava/lang/Object;)Luniffi/textrcs_libgm/RustBuffer$ByValue;
    ...
    invoke-virtual {p0, v0}, Luniffi/textrcs_libgm/FfiConverterSequenceString;->lowerIntoRustBuffer(Ljava/util/List;)Luniffi/textrcs_libgm/RustBuffer$ByValue;
...
.method public bridge synthetic read(Ljava/nio/ByteBuffer;)Ljava/lang/Object;
    ...
    .line 4739
    invoke-virtual {p0, p1}, Luniffi/textrcs_libgm/FfiConverterSequenceString;->read(Ljava/nio/ByteBuffer;)Ljava/util/List;
...
.method public read(Ljava/nio/ByteBuffer;)Ljava/util/List;
    ...
    .line 4743
    .local v4, "$i$a$-List-FfiConverterSequenceString$read$1":I
    sget-object v5, Luniffi/textrcs_libgm/FfiConverterString;->INSTANCE:Luniffi/textrcs_libgm/FfiConverterString;

    invoke-virtual {v5, p1}, Luniffi/textrcs_libgm/FfiConverterString;->read(Ljava/nio/ByteBuffer;)Ljava/lang/String;

    move-result-object v3

    .line 4742
    .end local v3    # "it":I
    .end local v4    # "$i$a$-List-FfiConverterSequenceString$read$1":I
...
.method public bridge synthetic write(Ljava/lang/Object;Ljava/nio/ByteBuffer;)V
    ...
    invoke-virtual {p0, v0, p2}, Luniffi/textrcs_libgm/FfiConverterSequenceString;->write(Ljava/util/List;Ljava/nio/ByteBuffer;)V
...
.method public write(Ljava/util/List;Ljava/nio/ByteBuffer;)V
    ...
    .line 4756
    .local v4, "$i$a$-forEach-FfiConverterSequenceString$write$1":I
    sget-object v5, Luniffi/textrcs_libgm/FfiConverterString;->INSTANCE:Luniffi/textrcs_libgm/FfiConverterString;

    invoke-virtual {v5, v3, p2}, Luniffi/textrcs_libgm/FfiConverterString;->write(Ljava/lang/String;Ljava/nio/ByteBuffer;)V
    ...
    .end local v4    # "$i$a$-forEach-FfiConverterSequenceString$write$1":I
    nop
