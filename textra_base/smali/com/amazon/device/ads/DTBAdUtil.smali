...
.method public static createAdMobBannerRequestBundle(Ljava/lang/String;IILjava/util/Map;)Landroid/os/Bundle;
    ...
    const-string p1, "Fail to execute createAdMobBannerRequestBundle method to create bundle for non smart banner ads"

    const/4 p2, 0x1

    invoke-static {p2, p2, p1, p0}, Lcom/mplus/lib/p1/a;->e(IILjava/lang/String;Ljava/lang/Exception;)V
...
.method public static createAdMobBannerRequestBundle(Ljava/lang/String;Ljava/util/Map;)Landroid/os/Bundle;
    ...
    const-string v0, "Fail to execute createAdMobBannerRequestBundle method to create bundle for smart banner ads"
...
.method private static createAdMobInterstitialRequestBundle(Ljava/lang/String;ZLjava/util/Map;)Landroid/os/Bundle;
    ...
    const-string p1, "Fail to execute createAdMobInterstitialRequestBundle method"
...
.method private static createBundleWithExtras(Ljava/util/Map;)Landroid/os/Bundle;
    ...
    :goto_1
    const-string v0, "Failed to add CCPA consent to AdMob mediation bundle"
...
.method public static generateRequestId()Ljava/lang/String;
    ...
    const-string v2, "Generate a conflict request id which already in request id map"

    const/4 v3, 0x1

    const/4 v4, 0x2

    invoke-static {v3, v4, v2, v1}, Lcom/mplus/lib/p1/a;->e(IILjava/lang/String;Ljava/lang/Exception;)V
...
.method public static pixelsToDeviceIndependenPixels(I)I
    ...
    const-string v0, "Fail to convert device pixel into device independent pixel"
...
.method public static sizeToDevicePixels(I)I
    ...
    const-string v0, "Fail to convert size into device pixel"
