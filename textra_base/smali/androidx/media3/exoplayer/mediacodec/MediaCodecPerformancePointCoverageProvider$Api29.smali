...
.method public static areResolutionAndFrameRateCovered(Landroid/media/MediaCodecInfo$VideoCapabilities;IID)I
    ...
    invoke-static {p0}, Lcom/mplus/lib/g0/b;->i(Landroid/media/MediaCodecInfo$VideoCapabilities;)Ljava/util/List;
    ...
    :cond_0
    invoke-static {}, Lcom/mplus/lib/g0/b;->k()V

    double-to-int p3, p3

    invoke-static {p1, p2, p3}, Lcom/mplus/lib/g0/b;->e(III)Landroid/media/MediaCodecInfo$VideoCapabilities$PerformancePoint;
...
.method private static evaluatePerformancePointCoverage(Ljava/util/List;Landroid/media/MediaCodecInfo$VideoCapabilities$PerformancePoint;)I
    ...
    invoke-static {v1}, Lcom/mplus/lib/g0/b;->f(Ljava/lang/Object;)Landroid/media/MediaCodecInfo$VideoCapabilities$PerformancePoint;

    move-result-object v1

    invoke-static {v1, p1}, Lcom/mplus/lib/g0/b;->u(Landroid/media/MediaCodecInfo$VideoCapabilities$PerformancePoint;Landroid/media/MediaCodecInfo$VideoCapabilities$PerformancePoint;)Z
...
.method private static shouldIgnorePerformancePoints()Z
    ...
    invoke-static {v4}, Lcom/mplus/lib/g0/b;->i(Landroid/media/MediaCodecInfo$VideoCapabilities;)Ljava/util/List;
    ...
    invoke-static {}, Lcom/mplus/lib/g0/b;->d()Landroid/media/MediaCodecInfo$VideoCapabilities$PerformancePoint;
