...
.method public static synthetic a(Landroidx/media3/exoplayer/drm/DrmSession;Landroidx/media3/exoplayer/drm/OfflineLicenseHelper;Lcom/mplus/lib/s3/B;)V
    .locals 0

    invoke-direct {p1, p0, p2}, Landroidx/media3/exoplayer/drm/OfflineLicenseHelper;->lambda$acquireFirstSessionOnHandlerThread$3(Landroidx/media3/exoplayer/drm/DrmSession;Lcom/mplus/lib/s3/B;)V
...
.method private acquireFirstSessionOnHandlerThread(I[BLandroidx/media3/common/Format;)Landroidx/media3/exoplayer/drm/DrmSession;
    ...
    new-instance v5, Lcom/mplus/lib/s3/B;
    ...
    :try_start_0
    invoke-virtual {v5}, Lcom/mplus/lib/s3/o;->get()Ljava/lang/Object;
    ...
    new-instance p2, Lcom/mplus/lib/s3/B;

    invoke-direct {p2}, Ljava/lang/Object;-><init>()V

    iget-object p3, v2, Landroidx/media3/exoplayer/drm/OfflineLicenseHelper;->handler:Landroid/os/Handler;

    new-instance v0, Lcom/mplus/lib/h0/f;

    invoke-direct {v0, p1, p0, p2}, Lcom/mplus/lib/h0/f;-><init>(Landroidx/media3/exoplayer/drm/DrmSession;Landroidx/media3/exoplayer/drm/OfflineLicenseHelper;Lcom/mplus/lib/s3/B;)V

    invoke-virtual {p3, v0}, Landroid/os/Handler;->post(Ljava/lang/Runnable;)Z

    :try_start_1
    invoke-virtual {p2}, Lcom/mplus/lib/s3/o;->get()Ljava/lang/Object;
...
.method private acquireSessionAndGetOfflineLicenseKeySetIdOnHandlerThread(I[BLandroidx/media3/common/Format;)[B
    ...
    invoke-direct {v0, p0, p2, p1, v1}, Lcom/mplus/lib/h0/f;-><init>(Landroidx/media3/exoplayer/drm/OfflineLicenseHelper;Lcom/mplus/lib/s3/B;Landroidx/media3/exoplayer/drm/DrmSession;I)V
...
.method public static synthetic b(Landroidx/media3/exoplayer/drm/OfflineLicenseHelper;Lcom/mplus/lib/s3/B;)V
    .locals 0

    invoke-direct {p0, p1}, Landroidx/media3/exoplayer/drm/OfflineLicenseHelper;->lambda$releaseManagerOnHandlerThread$4(Lcom/mplus/lib/s3/B;)V

    return-void
.end method

.method public static synthetic c(Landroidx/media3/exoplayer/drm/DrmSession;Landroidx/media3/exoplayer/drm/OfflineLicenseHelper;Lcom/mplus/lib/s3/B;)V
    .locals 0

    invoke-direct {p1, p2, p0}, Landroidx/media3/exoplayer/drm/OfflineLicenseHelper;->lambda$acquireSessionAndGetOfflineLicenseKeySetIdOnHandlerThread$1(Lcom/mplus/lib/s3/B;Landroidx/media3/exoplayer/drm/DrmSession;)V

    return-void
.end method

.method public static synthetic d(Landroidx/media3/exoplayer/drm/OfflineLicenseHelper;I[BLcom/mplus/lib/s3/B;Landroidx/media3/common/Format;)V
    .locals 0

    invoke-direct {p0, p1, p2, p3, p4}, Landroidx/media3/exoplayer/drm/OfflineLicenseHelper;->lambda$acquireFirstSessionOnHandlerThread$2(I[BLcom/mplus/lib/s3/B;Landroidx/media3/common/Format;)V

    return-void
.end method

.method public static synthetic e(Landroidx/media3/exoplayer/drm/DrmSession;Landroidx/media3/exoplayer/drm/OfflineLicenseHelper;Lcom/mplus/lib/s3/B;)V
    .locals 0

    invoke-direct {p1, p2, p0}, Landroidx/media3/exoplayer/drm/OfflineLicenseHelper;->lambda$getLicenseDurationRemainingSec$0(Lcom/mplus/lib/s3/B;Landroidx/media3/exoplayer/drm/DrmSession;)V

    return-void
.end method

.method private synthetic lambda$acquireFirstSessionOnHandlerThread$2(I[BLcom/mplus/lib/s3/B;Landroidx/media3/common/Format;)V
    .locals 3
    ...
    invoke-virtual {p3, p1}, Lcom/mplus/lib/s3/B;->l(Ljava/lang/Object;)Z
    :try_end_1
    .catchall {:try_start_1 .. :try_end_1} :catchall_0
    ...
    invoke-virtual {p3, p1}, Lcom/mplus/lib/s3/o;->k(Ljava/lang/Throwable;)Z

    return-void
.end method

.method private synthetic lambda$acquireFirstSessionOnHandlerThread$3(Landroidx/media3/exoplayer/drm/DrmSession;Lcom/mplus/lib/s3/B;)V
    .locals 3
    ...
    :cond_0
    :goto_0
    invoke-virtual {p2, v0}, Lcom/mplus/lib/s3/B;->l(Ljava/lang/Object;)Z
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0
    ...
    :goto_1
    invoke-virtual {p2, v0}, Lcom/mplus/lib/s3/o;->k(Ljava/lang/Throwable;)Z
...
.method private synthetic lambda$acquireSessionAndGetOfflineLicenseKeySetIdOnHandlerThread$1(Lcom/mplus/lib/s3/B;Landroidx/media3/exoplayer/drm/DrmSession;)V
    .locals 1
    ...
    invoke-virtual {p1, v0}, Lcom/mplus/lib/s3/B;->l(Ljava/lang/Object;)Z
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0
    ...
    :try_start_1
    invoke-virtual {p1, v0}, Lcom/mplus/lib/s3/o;->k(Ljava/lang/Throwable;)Z
    :try_end_1
...
.method private synthetic lambda$getLicenseDurationRemainingSec$0(Lcom/mplus/lib/s3/B;Landroidx/media3/exoplayer/drm/DrmSession;)V
    .locals 1
...
.method private synthetic lambda$releaseManagerOnHandlerThread$4(Lcom/mplus/lib/s3/B;)V
    .locals 1
...
.method private releaseManagerOnHandlerThread()V
    ...
    :try_start_0
    invoke-virtual {v0}, Lcom/mplus/lib/s3/o;->get()Ljava/lang/Object;
    :try_end_0
...
.method public declared-synchronized getLicenseDurationRemainingSec([B)Landroid/util/Pair;
    ...
    new-instance v2, Lcom/mplus/lib/h0/f;

    const/4 v3, 0x0

    invoke-direct {v2, p0, v0, p1, v3}, Lcom/mplus/lib/h0/f;-><init>(Landroidx/media3/exoplayer/drm/OfflineLicenseHelper;Lcom/mplus/lib/s3/B;Landroidx/media3/exoplayer/drm/DrmSession;I)V
