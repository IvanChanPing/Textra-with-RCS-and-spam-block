...
.method public constructor <init>([Landroidx/media3/exoplayer/Renderer;Landroidx/media3/exoplayer/trackselection/TrackSelector;Landroidx/media3/exoplayer/trackselection/TrackSelectorResult;Landroidx/media3/exoplayer/LoadControl;Landroidx/media3/exoplayer/upstream/BandwidthMeter;IZLandroidx/media3/exoplayer/analytics/AnalyticsCollector;Landroidx/media3/exoplayer/SeekParameters;Landroidx/media3/exoplayer/LivePlaybackSpeedControl;JZLandroid/os/Looper;Landroidx/media3/common/util/Clock;Landroidx/media3/exoplayer/ExoPlayerImplInternal$PlaybackInfoUpdateListener;Landroidx/media3/exoplayer/analytics/PlayerId;Landroid/os/Looper;)V
    ...
    iput-object v7, p0, Landroidx/media3/exoplayer/ExoPlayerImplInternal;->playbackInfoUpdateListener:Landroidx/media3/exoplayer/ExoPlayerImplInternal$PlaybackInfoUpdateListener;
    ...
    iput-wide v2, p0, Landroidx/media3/exoplayer/ExoPlayerImplInternal;->releaseTimeoutMs:J

    iput-wide v2, p0, Landroidx/media3/exoplayer/ExoPlayerImplInternal;->setForegroundModeTimeoutMs:J

    move/from16 v2, p13

    iput-boolean v2, p0, Landroidx/media3/exoplayer/ExoPlayerImplInternal;->pauseAtEndOfWindow:Z

    iput-object v4, p0, Landroidx/media3/exoplayer/ExoPlayerImplInternal;->clock:Landroidx/media3/common/util/Clock;

    const-wide v2, -0x7fffffffffffffffL    # -4.9E-324

    iput-wide v2, p0, Landroidx/media3/exoplayer/ExoPlayerImplInternal;->playbackMaybeBecameStuckAtMs:J

    iput-wide v2, p0, Landroidx/media3/exoplayer/ExoPlayerImplInternal;->lastRebufferRealtimeMs:J

    invoke-interface {p4}, Landroidx/media3/exoplayer/LoadControl;->getBackBufferDurationUs()J

    move-result-wide v2

    iput-wide v2, p0, Landroidx/media3/exoplayer/ExoPlayerImplInternal;->backBufferDurationUs:J
    ...
    invoke-direct {v2, p3}, Landroidx/media3/exoplayer/ExoPlayerImplInternal$PlaybackInfoUpdate;-><init>(Landroidx/media3/exoplayer/PlaybackInfo;)V
    ...
    invoke-interface {v3, v2, v5, v4}, Landroidx/media3/exoplayer/Renderer;->init(ILandroidx/media3/exoplayer/analytics/PlayerId;Landroidx/media3/common/util/Clock;)V
    ...
    invoke-interface {v7}, Landroidx/media3/exoplayer/Renderer;->getCapabilities()Landroidx/media3/exoplayer/RendererCapabilities;
    ...
    invoke-direct {p1, p0, v4}, Landroidx/media3/exoplayer/DefaultMediaClock;-><init>(Landroidx/media3/exoplayer/DefaultMediaClock$PlaybackParametersListener;Landroidx/media3/common/util/Clock;)V
    ...
    invoke-interface {v4, p2, p1}, Landroidx/media3/common/util/Clock;->createHandler(Landroid/os/Looper;Landroid/os/Handler$Callback;)Landroidx/media3/common/util/HandlerWrapper;
    ...
    invoke-direct {v0, v2, p0}, Landroidx/media3/exoplayer/d;-><init>(ILjava/lang/Object;)V

    invoke-direct {p3, v1, p2, v0}, Landroidx/media3/exoplayer/MediaPeriodQueue;-><init>(Landroidx/media3/exoplayer/analytics/AnalyticsCollector;Landroidx/media3/common/util/HandlerWrapper;Landroidx/media3/exoplayer/MediaPeriodHolder$Factory;)V
    ...
    iput-object v6, p0, Landroidx/media3/exoplayer/ExoPlayerImplInternal;->playbackLooper:Landroid/os/Looper;
    ...
    invoke-interface {v4, p1, p0}, Landroidx/media3/common/util/Clock;->createHandler(Landroid/os/Looper;Landroid/os/Handler$Callback;)Landroidx/media3/common/util/HandlerWrapper;
...
.method private doSomeWork()V
    ...
    invoke-direct {p0, v9, v9}, Landroidx/media3/exoplayer/ExoPlayerImplInternal;->updateRebufferingState(ZZ)V
    ...
    invoke-virtual {v3}, Landroidx/media3/exoplayer/DefaultMediaClock;->start()V
    ...
    iget-boolean v3, v2, Landroidx/media3/exoplayer/PlaybackInfo;->isLoading:Z
    ...
    iget-boolean v7, v6, Landroidx/media3/exoplayer/PlaybackInfo;->sleepingForOffload:Z
...
.method private extractMetadataFromTrackSelectionArray([Landroidx/media3/exoplayer/trackselection/ExoTrackSelection;)Lcom/mplus/lib/o3/U;
    .locals 8
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "([",
    ...
    invoke-virtual {v1, v6}, Lcom/mplus/lib/o3/N;->a(Ljava/lang/Object;)V
...
.method private handlePositionDiscontinuity(Landroidx/media3/exoplayer/source/MediaSource$MediaPeriodId;JJJZI)Landroidx/media3/exoplayer/PlaybackInfo;
    ...
    invoke-direct {p0, v3}, Landroidx/media3/exoplayer/ExoPlayerImplInternal;->extractMetadataFromTrackSelectionArray([Landroidx/media3/exoplayer/trackselection/ExoTrackSelection;)Lcom/mplus/lib/o3/U;
...
.method private updatePlaybackPositions()V
    ...
    invoke-direct {p0, v4, v5, v2, v3}, Landroidx/media3/exoplayer/ExoPlayerImplInternal;->maybeTriggerPendingMessages(JJ)V
...
.method private declared-synchronized waitUninterruptibly(Lcom/mplus/lib/n3/m;J)V
    .locals 5
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    :goto_0
    invoke-interface {p1}, Lcom/mplus/lib/n3/m;->get()Ljava/lang/Object;
...
.method public declared-synchronized release()Z
    ...
    invoke-direct {p0, v0, v1, v2}, Landroidx/media3/exoplayer/ExoPlayerImplInternal;->waitUninterruptibly(Lcom/mplus/lib/n3/m;J)V
...
.method public declared-synchronized setForegroundMode(Z)Z
    ...
    new-instance v0, Lcom/mplus/lib/e0/a;

    const/4 v1, 0x2

    invoke-direct {v0, v1, p1}, Lcom/mplus/lib/e0/a;-><init>(ILjava/lang/Object;)V
