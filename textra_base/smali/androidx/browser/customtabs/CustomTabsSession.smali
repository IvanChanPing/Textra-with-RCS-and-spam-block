...
# instance fields
.field private final mCallback:Lcom/mplus/lib/c/c;
...
.field private final mService:Lcom/mplus/lib/c/f;


# direct methods
.method public constructor <init>(Lcom/mplus/lib/c/f;Lcom/mplus/lib/c/c;Landroid/content/ComponentName;Landroid/app/PendingIntent;)V
    .locals 1
    ...
    iput-object p1, p0, Landroidx/browser/customtabs/CustomTabsSession;->mService:Lcom/mplus/lib/c/f;

    iput-object p2, p0, Landroidx/browser/customtabs/CustomTabsSession;->mCallback:Lcom/mplus/lib/c/c;
...
.method public static createMockSessionForTesting(Landroid/content/ComponentName;)Landroidx/browser/customtabs/CustomTabsSession;
    ...
    invoke-direct {v0, v1, v2, p0, v3}, Landroidx/browser/customtabs/CustomTabsSession;-><init>(Lcom/mplus/lib/c/f;Lcom/mplus/lib/c/c;Landroid/content/ComponentName;Landroid/app/PendingIntent;)V
...
.method public getBinder()Landroid/os/IBinder;
    ...
    iget-object v0, p0, Landroidx/browser/customtabs/CustomTabsSession;->mCallback:Lcom/mplus/lib/c/c;
...
.method public mayLaunchUrl(Landroid/net/Uri;Landroid/os/Bundle;Ljava/util/List;)Z
    ...
    :try_start_0
    iget-object v0, p0, Landroidx/browser/customtabs/CustomTabsSession;->mService:Lcom/mplus/lib/c/f;

    iget-object v1, p0, Landroidx/browser/customtabs/CustomTabsSession;->mCallback:Lcom/mplus/lib/c/c;

    invoke-interface {v0, v1, p1, p2, p3}, Lcom/mplus/lib/c/f;->mayLaunchUrl(Lcom/mplus/lib/c/c;Landroid/net/Uri;Landroid/os/Bundle;Ljava/util/List;)Z
...
.method public postMessage(Ljava/lang/String;Landroid/os/Bundle;)I
    ...
    :try_start_0
    iget-object v1, p0, Landroidx/browser/customtabs/CustomTabsSession;->mService:Lcom/mplus/lib/c/f;

    iget-object v2, p0, Landroidx/browser/customtabs/CustomTabsSession;->mCallback:Lcom/mplus/lib/c/c;

    invoke-interface {v1, v2, p1, p2}, Lcom/mplus/lib/c/f;->postMessage(Lcom/mplus/lib/c/c;Ljava/lang/String;Landroid/os/Bundle;)I
...
.method public receiveFile(Landroid/net/Uri;ILandroid/os/Bundle;)Z
    ...
    invoke-interface {v0, v1, p1, p2, p3}, Lcom/mplus/lib/c/f;->receiveFile(Lcom/mplus/lib/c/c;Landroid/net/Uri;ILandroid/os/Bundle;)Z
...
.method public requestPostMessageChannel(Landroid/net/Uri;)Z
    ...
    invoke-interface {v0, v1, p1, v2}, Lcom/mplus/lib/c/f;->requestPostMessageChannelWithExtras(Lcom/mplus/lib/c/c;Landroid/net/Uri;Landroid/os/Bundle;)Z
    ...
    invoke-interface {v0, v1, p1}, Lcom/mplus/lib/c/f;->requestPostMessageChannel(Lcom/mplus/lib/c/c;Landroid/net/Uri;)Z
...
.method public setActionButton(Landroid/graphics/Bitmap;Ljava/lang/String;)Z
    ...
    :try_start_0
    iget-object p2, p0, Landroidx/browser/customtabs/CustomTabsSession;->mService:Lcom/mplus/lib/c/f;

    iget-object v0, p0, Landroidx/browser/customtabs/CustomTabsSession;->mCallback:Lcom/mplus/lib/c/c;

    invoke-interface {p2, v0, p1}, Lcom/mplus/lib/c/f;->updateVisuals(Lcom/mplus/lib/c/c;Landroid/os/Bundle;)Z
...
.method public setSecondaryToolbarViews(Landroid/widget/RemoteViews;[ILandroid/app/PendingIntent;)Z
    ...
    :try_start_0
    iget-object p1, p0, Landroidx/browser/customtabs/CustomTabsSession;->mService:Lcom/mplus/lib/c/f;

    iget-object p2, p0, Landroidx/browser/customtabs/CustomTabsSession;->mCallback:Lcom/mplus/lib/c/c;

    invoke-interface {p1, p2, v0}, Lcom/mplus/lib/c/f;->updateVisuals(Lcom/mplus/lib/c/c;Landroid/os/Bundle;)Z
...
.method public setToolbarItem(ILandroid/graphics/Bitmap;Ljava/lang/String;)Z
    ...
    iget-object p3, p0, Landroidx/browser/customtabs/CustomTabsSession;->mCallback:Lcom/mplus/lib/c/c;

    invoke-interface {p2, p3, p1}, Lcom/mplus/lib/c/f;->updateVisuals(Lcom/mplus/lib/c/c;Landroid/os/Bundle;)Z
...
.method public validateRelationship(ILandroid/net/Uri;Landroid/os/Bundle;)Z
    ...
    invoke-interface {v0, v2, p1, p2, p3}, Lcom/mplus/lib/c/f;->validateRelationship(Lcom/mplus/lib/c/c;ILandroid/net/Uri;Landroid/os/Bundle;)Z
