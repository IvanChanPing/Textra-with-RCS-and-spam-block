...
.method public constructor <init>(Landroidx/browser/customtabs/CustomTabsService;)V
    ...
    invoke-direct {p0}, Lcom/mplus/lib/c/e;-><init>()V

    return-void
.end method

.method public static synthetic c(Landroidx/browser/customtabs/CustomTabsService$1;Landroidx/browser/customtabs/CustomTabsSessionToken;)V
    .locals 0
...
.method private newSessionInternal(Lcom/mplus/lib/c/c;Landroid/app/PendingIntent;)Z
    .locals 4
    .param p1    # Lcom/mplus/lib/c/c;
    ...
    invoke-direct {v0, p1, p2}, Landroidx/browser/customtabs/CustomTabsSessionToken;-><init>(Lcom/mplus/lib/c/c;Landroid/app/PendingIntent;)V
...
.method public mayLaunchUrl(Lcom/mplus/lib/c/c;Landroid/net/Uri;Landroid/os/Bundle;Ljava/util/List;)Z
    .locals 3
    .param p1    # Lcom/mplus/lib/c/c;
        .annotation build Landroidx/annotation/Nullable;
        .end annotation
    ...
    invoke-direct {v1, p1, v2}, Landroidx/browser/customtabs/CustomTabsSessionToken;-><init>(Lcom/mplus/lib/c/c;Landroid/app/PendingIntent;)V
...
.method public newSession(Lcom/mplus/lib/c/c;)Z
    .locals 1
    .param p1    # Lcom/mplus/lib/c/c;
        .annotation build Landroidx/annotation/NonNull;
        .end annotation
    ...
    invoke-direct {p0, p1, v0}, Landroidx/browser/customtabs/CustomTabsService$1;->newSessionInternal(Lcom/mplus/lib/c/c;Landroid/app/PendingIntent;)Z
...
.method public newSessionWithExtras(Lcom/mplus/lib/c/c;Landroid/os/Bundle;)Z
    .locals 0
    .param p1    # Lcom/mplus/lib/c/c;
        .annotation build Landroidx/annotation/NonNull;
        .end annotation
    ...
    invoke-direct {p0, p1, p2}, Landroidx/browser/customtabs/CustomTabsService$1;->newSessionInternal(Lcom/mplus/lib/c/c;Landroid/app/PendingIntent;)Z
...
.method public postMessage(Lcom/mplus/lib/c/c;Ljava/lang/String;Landroid/os/Bundle;)I
    .locals 3
    .param p1    # Lcom/mplus/lib/c/c;
        .annotation build Landroidx/annotation/NonNull;
        .end annotation
...
.method public receiveFile(Lcom/mplus/lib/c/c;Landroid/net/Uri;ILandroid/os/Bundle;)Z
    .locals 3
    .param p1    # Lcom/mplus/lib/c/c;
        .annotation build Landroidx/annotation/NonNull;
        .end annotation
...
.method public requestPostMessageChannel(Lcom/mplus/lib/c/c;Landroid/net/Uri;)Z
    .locals 3
    .param p1    # Lcom/mplus/lib/c/c;
        .annotation build Landroidx/annotation/NonNull;
        .end annotation
...
.method public requestPostMessageChannelWithExtras(Lcom/mplus/lib/c/c;Landroid/net/Uri;Landroid/os/Bundle;)Z
    .locals 2
    .param p1    # Lcom/mplus/lib/c/c;
        .annotation build Landroidx/annotation/NonNull;
        .end annotation
    ...
    invoke-direct {v1, p1, p3}, Landroidx/browser/customtabs/CustomTabsSessionToken;-><init>(Lcom/mplus/lib/c/c;Landroid/app/PendingIntent;)V
...
.method public updateVisuals(Lcom/mplus/lib/c/c;Landroid/os/Bundle;)Z
    .locals 3
    .param p1    # Lcom/mplus/lib/c/c;
        .annotation build Landroidx/annotation/NonNull;
        .end annotation
...
.method public validateRelationship(Lcom/mplus/lib/c/c;ILandroid/net/Uri;Landroid/os/Bundle;)Z
    .locals 3
    .param p1    # Lcom/mplus/lib/c/c;
        .annotation build Landroidx/annotation/NonNull;
        .end annotation
