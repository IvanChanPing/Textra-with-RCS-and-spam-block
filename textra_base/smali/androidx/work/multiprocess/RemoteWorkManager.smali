...
.method public abstract cancelAllWork()Lcom/mplus/lib/s3/v;
    .annotation build Landroidx/annotation/NonNull;
    .end annotation
...
.method public abstract cancelAllWorkByTag(Ljava/lang/String;)Lcom/mplus/lib/s3/v;
    .param p1    # Ljava/lang/String;
        .annotation build Landroidx/annotation/NonNull;
        .end annotation
    .end param
...
.method public abstract cancelUniqueWork(Ljava/lang/String;)Lcom/mplus/lib/s3/v;
    .param p1    # Ljava/lang/String;
        .annotation build Landroidx/annotation/NonNull;
        .end annotation
    .end param
...
.method public abstract cancelWorkById(Ljava/util/UUID;)Lcom/mplus/lib/s3/v;
...
.method public abstract enqueue(Landroidx/work/WorkContinuation;)Lcom/mplus/lib/s3/v;
...
.method public abstract enqueue(Landroidx/work/WorkRequest;)Lcom/mplus/lib/s3/v;
...
.method public abstract enqueue(Ljava/util/List;)Lcom/mplus/lib/s3/v;
    .param p1    # Ljava/util/List;
        .annotation build Landroidx/annotation/NonNull;
        .end annotation
    .end param
...
.method public abstract enqueueUniquePeriodicWork(Ljava/lang/String;Landroidx/work/ExistingPeriodicWorkPolicy;Landroidx/work/PeriodicWorkRequest;)Lcom/mplus/lib/s3/v;
    .param p1    # Ljava/lang/String;
        .annotation build Landroidx/annotation/NonNull;
        .end annotation
    .end param
...
.method public final enqueueUniqueWork(Ljava/lang/String;Landroidx/work/ExistingWorkPolicy;Landroidx/work/OneTimeWorkRequest;)Lcom/mplus/lib/s3/v;
    .locals 0
    .param p1    # Ljava/lang/String;
        .annotation build Landroidx/annotation/NonNull;
        .end annotation
    ...
    invoke-virtual {p0, p1, p2, p3}, Landroidx/work/multiprocess/RemoteWorkManager;->enqueueUniqueWork(Ljava/lang/String;Landroidx/work/ExistingWorkPolicy;Ljava/util/List;)Lcom/mplus/lib/s3/v;
...
.method public abstract enqueueUniqueWork(Ljava/lang/String;Landroidx/work/ExistingWorkPolicy;Ljava/util/List;)Lcom/mplus/lib/s3/v;
    .param p1    # Ljava/lang/String;
        .annotation build Landroidx/annotation/NonNull;
        .end annotation
    .end param
...
.method public abstract getWorkInfos(Landroidx/work/WorkQuery;)Lcom/mplus/lib/s3/v;
...
.method public abstract setForegroundAsync(Ljava/lang/String;Landroidx/work/ForegroundInfo;)Lcom/mplus/lib/s3/v;
    .param p1    # Ljava/lang/String;
        .annotation build Landroidx/annotation/NonNull;
        .end annotation
    .end param
...
.method public abstract setProgress(Ljava/util/UUID;Landroidx/work/Data;)Lcom/mplus/lib/s3/v;
    .param p1    # Ljava/util/UUID;
        .annotation build Landroidx/annotation/NonNull;
        .end annotation
    .end param
