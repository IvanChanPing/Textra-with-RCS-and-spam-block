...
.method private synthetic lambda$run$0(Landroidx/work/impl/utils/futures/SettableFuture;)V
    ...
    invoke-virtual {v0}, Landroidx/work/ListenableWorker;->getForegroundInfoAsync()Lcom/mplus/lib/s3/v;

    move-result-object v0

    invoke-virtual {p1, v0}, Landroidx/work/impl/utils/futures/SettableFuture;->setFuture(Lcom/mplus/lib/s3/v;)Z
