...
.method public static final dropFtsSyncTriggers(Landroidx/sqlite/db/SupportSQLiteDatabase;)V
    ...
    check-cast v1, Lcom/mplus/lib/W9/a;

    invoke-virtual {v1}, Lcom/mplus/lib/W9/a;->hasNext()Z

    move-result v2

    if-eqz v2, :cond_2

    invoke-virtual {v1}, Lcom/mplus/lib/W9/a;->next()Ljava/lang/Object;
    ...
    invoke-static {v1, v2, v3}, Lcom/mplus/lib/ra/p;->X(Ljava/lang/String;Ljava/lang/String;Z)Z
    ...
    invoke-static {v1, p0}, Lcom/mplus/lib/a3/V0;->u(Ljava/io/Closeable;Ljava/lang/Throwable;)V
...
.method public static final readVersion(Ljava/io/File;)I
    ...
    invoke-static {v1, v0}, Lcom/mplus/lib/a3/V0;->u(Ljava/io/Closeable;Ljava/lang/Throwable;)V
