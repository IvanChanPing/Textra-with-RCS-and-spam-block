...
.method public final loadMainDispatcherFactory$kotlinx_coroutines_core()Ljava/util/List;
    ...
    .line 167
    .local v9, "$this$loadMainDispatcherFactory_u24lambda_u240":Lkotlinx/coroutines/internal/MainDispatcherFactory;
    const/4 v2, 0x0

    .line 60
    .local v2, "$i$a$-apply-FastServiceLoader$loadMainDispatcherFactory$1":I
    :try_start_42
    invoke-virtual {v1, v9}, Ljava/util/ArrayList;->add(Ljava/lang/Object;)Z

    .line 61
    .end local v2    # "$i$a$-apply-FastServiceLoader$loadMainDispatcherFactory$1":I
    .end local v9    # "$this$loadMainDispatcherFactory_u24lambda_u240":Lkotlinx/coroutines/internal/MainDispatcherFactory;
    :cond_45
    const-string v2, "kotlinx.coroutines.test.internal.TestMainDispatcherFactory"
    :try_end_47
    .catchall {:try_start_42 .. :try_end_47} :catchall_73

    .local v2, "serviceClass$iv":Ljava/lang/String;
    move-object v3, p0

    .restart local v3    # "this_$iv":Lkotlinx/coroutines/internal/FastServiceLoader;
    const/4 v4, 0x0
    ...
    :try_end_64
    .catch Ljava/lang/ClassNotFoundException; {:try_start_4a .. :try_end_64} :catch_66
    ...
    .line 167
    .local v5, "$this$loadMainDispatcherFactory_u24lambda_u241":Lkotlinx/coroutines/internal/MainDispatcherFactory;
    const/4 v2, 0x0

    .line 61
    .local v2, "$i$a$-apply-FastServiceLoader$loadMainDispatcherFactory$2":I
    :try_start_6c
    invoke-virtual {v1, v5}, Ljava/util/ArrayList;->add(Ljava/lang/Object;)Z

    .line 62
    .end local v2    # "$i$a$-apply-FastServiceLoader$loadMainDispatcherFactory$2":I
    .end local v5    # "$this$loadMainDispatcherFactory_u24lambda_u241":Lkotlinx/coroutines/internal/MainDispatcherFactory;
    :cond_6f
    nop
