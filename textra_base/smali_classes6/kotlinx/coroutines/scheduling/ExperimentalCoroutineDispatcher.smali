...
.method public synthetic constructor <init>(II)V
    ...
    .end local p1    # "corePoolSize":I
    .end local p2    # "maxPoolSize":I
...
.method public constructor <init>(IILjava/lang/String;)V
    ...
    .end local p1    # "corePoolSize":I
    .end local p2    # "maxPoolSize":I
    .end local p3    # "schedulerName":Ljava/lang/String;
    .local v1, "corePoolSize":I
    .local v2, "maxPoolSize":I
    .local v5, "schedulerName":Ljava/lang/String;
    invoke-direct/range {v0 .. v5}, Lkotlinx/coroutines/scheduling/ExperimentalCoroutineDispatcher;-><init>(IIJLjava/lang/String;)V
...
.method public dispatch(Lkotlin/coroutines/CoroutineContext;Ljava/lang/Runnable;)V
    ...
    iget-object v0, p0, Lkotlinx/coroutines/scheduling/ExperimentalCoroutineDispatcher;->coroutineScheduler:Lkotlinx/coroutines/scheduling/CoroutineScheduler;
    :try_end_3
    .catch Ljava/util/concurrent/RejectedExecutionException; {:try_start_1 .. :try_end_3} :catch_f
    ...
    :try_end_b
    .catch Ljava/util/concurrent/RejectedExecutionException; {:try_start_8 .. :try_end_b} :catch_c
    ...
    .end local v1    # "block":Ljava/lang/Runnable;
    .restart local p2    # "block":Ljava/lang/Runnable;
    :catch_f
    move-exception v0
    ...
    .line 54
    .restart local v1    # "block":Ljava/lang/Runnable;
    .local p2, "e":Ljava/util/concurrent/RejectedExecutionException;
    :goto_12
    ...
    .line 55
    .end local p2    # "e":Ljava/util/concurrent/RejectedExecutionException;
    :goto_17
    return-void
.end method
