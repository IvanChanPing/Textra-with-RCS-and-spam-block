...
.method public final joinBlocking()Ljava/lang/Object;
    ...
    :try_end_4a
    .catchall {:try_start_43 .. :try_end_4a} :catchall_84
    ...
    .line 103
    .local v3, "it":Lkotlinx/coroutines/CompletedExceptionally;
    :cond_67
    const/4 v1, 0x0

    .line 98
    .local v1, "$i$a$-let-BlockingCoroutine$joinBlocking$2":I
    ...
    .end local v1    # "$i$a$-let-BlockingCoroutine$joinBlocking$2":I
    .end local v3    # "it":Lkotlinx/coroutines/CompletedExceptionally;
    :cond_6b
    :try_start_6b
